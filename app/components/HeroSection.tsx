    ...
    >
      ...
      <div
        className={`relative z-10 max-w-4xl w-full mx-4 ${
          showAllSkills ? "max-h-[85vh] overflow-y-auto" : ""
        }`}
      >
        <motion.div
          ...
          <div className="font-mono space-y-3">
            ...
            >
              ...
              <p className="text-text-secondary mb-3">
                Computer Science Student @ UBC | Undergraduate Research and
                Teaching Assistant @ UBC | Aspiring Software Engineer
              </p>
            </motion.div>
            ...
            {!showAllSkills ? (
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mt-2 mb-4">
                  <span className="px-3 py-1 bg-accent-red-dark/20 rounded-md border border-accent-red-dark/30 text-sm">
                    JavaScript
                  </span>
                  <span className="px-3 py-1 bg-accent-red-dark/20 rounded-md border border-accent-red-dark/30 text-sm">
                    React
              ...
              <>
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-2 mb-3">
                    <span className="px-2 py-1 bg-accent-red-dark/20 rounded-md border border-accent-red-dark/30 text-xs">
                      JavaScript
                    </span>
                    <span className="px-2 py-1 bg-accent-red-dark/20 rounded-md border border-accent-red-dark/30 text-xs">
                      TypeScript
                ...
                >
                  <p className="text-accent-red">
                    $ cat frameworks-and-libraries.txt
                  </p>
                  <div className="flex flex-wrap gap-1.5 mt-2 mb-3">
                    <span className="px-2 py-1 bg-accent-red-dark/20 rounded-md border border-accent-red-dark/30 text-xs">
                      React
                ...
                >
                  <p className="text-accent-red">
                    $ cat data-science-and-visualization.txt
                  </p>
                ...
                >
                  <p className="text-accent-red">
                    $ cat scripting-and-utilities.txt
                  </p>
                  <div className="flex flex-wrap gap-1.5 mt-2 mb-4">
                    <span className="px-2 py-1 bg-accent-red-dark/20 rounded-md border border-accent-red-dark/30 text-xs">
                      REST APIs
