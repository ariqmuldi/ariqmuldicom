...
export default function EducationSection() {
  ...
  const achievements = [
    { icon: "🏆", title: "2x Dean's List", description: "Academic Excellence" },
    { icon: "⭐", title: "Top 5%", description: "Class Ranking" },
    { icon: "🎓", title: "1x Dean's Scholar", description: "Academic Excellence" },
    { icon: "📚", title: "4.21/4.33 GPA", description: "90.6% Average" },
  ];
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                  {coursework.map((course, index) => (
                    <motion.div
                      ...
                      className="group"
                    >
                      <div className="px-3 py-2 bg-white/50 hover:bg-white/70 rounded-lg border border-accent-purple/10 hover:border-accent-purple/30 transition-all duration-300 cursor-default">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-secondary">
                    Udemy Certification • 100 Days of Code
                  </p>
                  <p className="text-xs text-text-muted mt-2">
                    Advanced Python programming, web development, data science, and automation
                  </p>
                </div>
              </div>
            </div>
